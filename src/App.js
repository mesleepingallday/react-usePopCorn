    ...
    <>
      ...
      <Main>
        ...
        {selectedId ? (
          ...
          <WatchedBox watched={watched} onDeleteWatched={handleDeleteWatched} />
        )}
      </Main>
    </>
  );
}
function MovieDetails({ selectedId, onCloseWindow, onAddWatched, watched }) {
  ...
  return (
    <div className="box">
      {isLoading ? (
        ...
        <React.Fragment>
          <header>
            <button className="btn-back" onClick={onCloseWindow}>
              &larr;
            </button>
